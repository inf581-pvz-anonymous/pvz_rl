...
class PolicynetAC(nn.Module):
    def __init__(self, input_size, output_size, hidden_size=80):
        super(PolicynetAC, self).__init__()
...
class ValuenetAC(nn.Module):
    def __init__(self, input_size, output_size, hidden_size=80):
        super(ValuenetAC, self).__init__()
        self.affine1 = nn.Linear(input_size, hidden_size)
...
class ACAgent():
    def __init__(self,input_size, possible_actions):
        ...
        self.policy = PolicynetAC(input_size, output_size=len(possible_actions))
        self.valuenet = ValuenetAC(input_size, output_size=len(possible_actions))
